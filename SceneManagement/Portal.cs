...
namespace RPG.SceneManagement
{
    public class Portal : MonoBehaviour
    {
        ...
        [SerializeField] float fadeInTimer = 2f;
        [SerializeField] float fadeWaitTime = 2f;
        [SerializeField] float portalInCD = 2f;
        ...
        private IEnumerator Transition()
        {
            ...
            wrapper.Save(); //saving again to check point once we go through the portal
        ...
        private Portal GetOtherPortal()
        {
            ...
            {
                if (p == this) continue;
                if (p.destination != destination) continue;
